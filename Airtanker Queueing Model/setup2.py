...
setup (name = 'Airtanker_Queueing_Model', version = '1.0', author = 'Cameron', description = \
       "Simple Airtanker Queueing Model", data_files = data_files, \
       windows = ['queueing_gui.py'], excludes= exclude_list, compressed=True)
