...
def mean_time_between_fires(env, fires_per_day): #used calculate fire ignition times
...
def human_fire_wait_time(env, inputs):
    ...
    wait_time = random.expovariate(1.0/mean_time_between_fires(env, num_fires))
    return wait_time
...
def at_control_fire_time_calc(env, fire, airtanker, inputs):
    ...
    time_per_drop = 2.0 * lake_distance / airtanker.fight_airspeed
